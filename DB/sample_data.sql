/* =========================================================
 * Uni-Place sample data (broad scenario seed) - V2 compatible
 * - Keeps B's large-scale rooms generation (buildings 1~8, floors 1~15, 20 rooms per floor)
 * - Aligns to A's V2: product_building_stock + cart_items.building_id + order_items.building_id
...
(building_id, building_nm, building_addr, building_desc, land_category, build_size, building_usage, exist_elv, parking_capacity, delete_yn)
VALUES
...
/* =========================================================
 * 11) payments/orders (✅ V2: order_items에 building_id 포함)
 * ========================================================= */
INSERT INTO payment
...
/* ✅ V2: building_id 포함 (주문별 빌딩 출처 세팅) */
