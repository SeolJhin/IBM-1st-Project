...
INTENT_DESCRIPTIONS = {
    ...
    "PAYMENT_STATUS_SUMMARY":      "결제·납부·청구·관리비·영수증·결제현황·납부현황 (계약/계약현황/계약정보는 MY_CONTRACT로 분류할 것)",
    "PAYMENT_SUMMARY_DOCUMENT":    "결제 내역 문서·상세 정산 요청·결제문서 생성",
    "ROOMSERVICE_STOCK_MONITOR":   "룸서비스·청소·수건·린넨·비품 재고 현황",
    "COMPLAIN_PRIORITY_CLASSIFY":  "민원·불편사항·소음·하자·수리 신고·접수·제출 (내 민원 조회는 MY_COMPLAIN으로 분류할 것)",
    "REVIEW_INFO":                 "리뷰·후기·별점·평점·만족도 조회 (커뮤니티 게시글 검색은 COMMUNITY_CONTENT_SEARCH로 분류할 것)",
    "TOUR_INFO":                   "투어·견학·방문·현장 확인 일반 안내·투어 방법 (내 투어 예약 확인은 MY_TOUR로 분류할 것)",
    "COMPANY_INFO":                "회사 정보·대표·전화·이메일·주소·고객센터 문의",
    "MY_CONTRACT":                 "내 계약 확인·조회·계약현황·계약정보·계약 기간·계약 알려줘·내 월세·보증금·납부일·언제까지 계약 (로그인 필요)",
    "MY_RESERVATION":              "내 공용시설 예약 내역·내 예약 확인·내 예약 현황 (공용공간 신규 예약은 COMMON_SPACE_RECOMMEND로 분류할 것, 로그인 필요)",
    "MY_TOUR":                     "내 투어 예약 확인·내 투어 조회·내 투어 내역 (투어 일반 안내는 TOUR_INFO로 분류할 것, 로그인 필요)",
    "MY_COMPLAIN":                 "내 민원 현황·내 민원 조회·접수 확인·민원 내역 보기 (민원 신고·접수는 COMPLAIN_PRIORITY_CLASSIFY로 분류할 것, 로그인 필요)",
