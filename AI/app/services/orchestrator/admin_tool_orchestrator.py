...
def run_admin_tool_orchestrator(req: AiRequest) -> AiResponse:
    ...
    try:
        slots = req.slots or {}
        return _run_admin(prompt, req.get_history(), admin_id, provider, slots=slots)
    except Exception as e:
...
def _run_admin(prompt: str, history: list[dict], admin_id: str, provider: str, slots: dict = None) -> AiResponse:
    slots = slots or {}
