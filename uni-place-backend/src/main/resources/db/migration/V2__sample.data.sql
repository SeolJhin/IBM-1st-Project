...
('REVIEW_CATEGORY', 'Review Category', 'Review classification', 1),
...
INSERT INTO common_code (group_code, code, code_value, description, display_order, is_active) VALUES
                                                                                                  ('BOARD_CATEGORY', 'BOARD_FREE',   'Free',        'Free board', 1, 1),                         ('BOARD_CATEGORY', 'BOARD_QUESTION', 'Question',  'Question board', 2, 1),
...
('AFFILIATE_CATEGORY', 'AFF_APPL','Appliance partner','Appliance affiliate', 4, 1),
('AFFILIATE_CATEGORY', 'AFF_LAUNDRY','Laundry partner','Laundry affiliate', 5, 1),
...
(1, 'Meeting Room A', 1,  8, 2, 'tv,whiteboard', 'Meeting room A'),
(2, 'Lounge A',       1, 20, 1, 'coffee,sofa',   'Lounge A'),
(3, 'Gym A',          1, 15, 1, 'fitness',       'Gym A'),
(4, 'Pet Care A',     1, 20, 1, 'pet,play,rest', 'Pet Care A'),
(5, 'Study Room A',   1, 20, 5, 'study,work',    'Study Room A'),
(6, 'Meeting Room B', 2, 10, 2, 'tv,whiteboard', 'Meeting room B'),
(7, 'Lounge B',       2, 20, 2, 'coffee,sofa',   'Lounge B'),
(8, 'Gym B',          2, 15, 1, 'fitness',       'Gym B'),
(9, 'Study Room B',   2, 20, 3, 'study,work',    'Study Room B'),
(10,'Lounge C',       3, 20, 1, 'coffee,sofa',   'Lounge C'),
(11,'Gym C',          3, 15, 1, 'fitness',       'Gym C'),
(12,'Pet Care C',     3, 20, 1, 'pet,play,rest', 'Pet Care C');
...
(2, 1, 'Uni Cleaning', 'Lee',  '02-555-6666', '222-33-44444', NULL,          'clean@uniplace.com', 'Seoul B-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_CLEAN', 'Building A cleaning', 'progress'),
(3, 1, 'Uni Furniture', 'Kim',  '02-777-8888', '333-44-55555', NULL,          'furniture@uniplace.com', 'Seoul C-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_FURN', 'Building A Furniture', 'planned'),
(4, 1, 'Uni Appliance', 'Kim',  '02-777-8888', '333-44-55556', NULL,          'appliance@uniplace.com', 'Seoul C-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_APPL', 'Building A appliance', 'planned'),
(5, 1, 'Uni Laundry', 'Lee',  '02-555-6666', '222-33-44445', NULL,          'laundry@uniplace.com', 'Seoul B-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_LAUNDRY', 'Building A laundry', 'ended'),
(6, 1, 'Uni Pet', 'Park', '02-333-4444', '111-22-33334', '02-333-4445', 'pet@uniplace.com',  'Seoul A-ro 101', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_PET',  'Building A pet',     'progress'),
(7, 2, 'Uni Cafe',     'Park', '02-333-4444', '111-22-33335', '02-333-4445', 'cafe@uniplace.com',  'Seoul A-ro 101', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_FOOD',  'Building B cafe',     'progress'),
(8, 2, 'Uni Cleaning', 'Lee',  '02-555-6666', '222-33-44446', NULL,          'clean@uniplace.com', 'Seoul B-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_CLEAN', 'Building B cleaning', 'progress'),
(9, 2, 'Uni Furniture', 'Kim',  '23-777-8888', '333-44-55557', NULL,          'furniture@uniplace.com', 'Seoul C-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_FURN', 'Building B Furniture', 'planned'),
(10, 2, 'Uni Appliance', 'Kim',  '02-777-8888', '333-44-55558', NULL,          'appliance@uniplace.com', 'Seoul C-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_APPL', 'Building B appliance', 'planned'),
(11, 2, 'Uni Laundry', 'Lee',  '02-555-6666', '222-33-44447', NULL,          'laundry@uniplace.com', 'Seoul B-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_LAUNDRY', 'Building B laundry', 'planned'),
(12, 3, 'Uni Cafe',     'Park', '02-333-4444', '111-22-33336', '02-333-4445', 'cafe@uniplace.com',  'Seoul A-ro 101', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_FOOD',  'Building C cafe',     'progress'),
(13, 3, 'Uni Cleaning', 'Lee',  '02-555-6666', '222-33-44448', NULL,          'clean@uniplace.com', 'Seoul B-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_CLEAN', 'Building C cleaning', 'progress'),
(14, 3, 'Uni Furniture', 'Kim',  '23-777-8888', '333-44-55559', NULL,          'furniture@uniplace.com', 'Seoul C-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_FURN', 'Building C Furniture', 'progress'),
(15, 3, 'Uni Appliance', 'Kim',  '02-777-8888', '333-44-55550', NULL,          'appliance@uniplace.com', 'Seoul C-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_APPL', 'Building C appliance', 'progress'),
(16, 3, 'Uni Laundry', 'Lee',  '02-555-6666', '222-33-44449', NULL,          'laundry@uniplace.com', 'Seoul B-ro 202', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_LAUNDRY', 'Building C laundry', 'planned'),
(17, 3, 'Uni Pet', 'Park', '02-333-4444', '111-22-33337', '02-333-4445', 'pet@uniplace.com',  'Seoul A-ro 101', NOW(), DATE_ADD(NOW(), INTERVAL 365 DAY), 'AFF_PET',  'Building C pet',     'planned');
...
(3, 1, 10), (3, 2, 40), (3, 3, 40),
(4, 1, 25), (4, 2, 25), (4, 3, 25),
(5, 1,  5), (5, 2, 60), (5, 3, 60),
(6,  1, 80), (6,  2, 70),
(7,  1, 40), (7,  2, 35),
(8,  1, 30), (8,  2, 28),
...
(7, 2, 1, '2026-02-24 13:00:00', '2026-02-24 14:00:00', 'Choi2 Guest',  '010-7000-0007', 'confirmed', '1234'),
(8, 3, 1, '2026-02-15 14:00:00', '2026-02-15 15:00:00', 'Lee2 Guest',  '010-7000-0008', 'ended', '1234'),
(9, 1, 1, '2026-02-12 16:00:00', '2026-02-12 17:00:00', 'Jung Guest',  '010-7000-0009', 'confirmed', '1234'),
(10, 2, 1, '2025-01-03 10:00:00', '2025-01-03 11:00:00', 'Jung2 Guest',  '010-7000-0010', 'ended', '1234');
...
(2, 2, 6, 'user4',  '2026-03-16 19:00:00', '2026-03-16 21:00:00', 8, 'confirmed'),
