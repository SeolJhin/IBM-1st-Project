    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/complains/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/complains/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/complains").hasAnyRole("ADMIN", "USER")
                .requestMatchers(HttpMethod.POST, "/api/complains").hasAnyRole("ADMIN", "USER")
                ...
                .requestMatchers(HttpMethod.GET, "/qna/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/qna").hasAnyRole("ADMIN", "USER")
