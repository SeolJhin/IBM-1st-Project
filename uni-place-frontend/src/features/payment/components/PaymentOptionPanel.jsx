...
export default function PaymentOptionPanel({
  ...
  const cardCompanies = [
    ...
    { id: 'kbank', short: 'k', label: '카카오뱅크', color: '#f5cc00', darkText: true },
  ...
  return (
    <div className={styles.wrap}>
      ...
      <button
        type="button"
        className={cls(styles.mainCardBtn, selectedOption === 'card' && styles.selected)}
        disabled={loading}
      ...
      <div className={styles.tabs}>
        {[
          ...
          <button
            key={tab.id}
            type="button"
            className={cls(styles.tab, methodGroup === tab.id && styles.tabActive)}
